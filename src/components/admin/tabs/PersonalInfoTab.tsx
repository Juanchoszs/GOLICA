          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                />
                {editedPlayer.initial_password && (
                  <div className="flex flex-col justify-center px-3 border border-border rounded-md bg-muted/50 min-w-[120px]">
                    <span className="text-[10px] text-muted-foreground font-semibold uppercase">Pass Inicial</span>
                    <span className="text-sm font-mono text-primary font-bold">{editedPlayer.initial_password}</span>
                  </div>
                )}
              </div>
            </div>
                ...
                {categories.map(cat => {
                  ...
                  return (
                    <div
                      ...
                      className={`cursor-pointer px-3 py-1.5 rounded-full text-sm font-medium transition-all ${isSelected
